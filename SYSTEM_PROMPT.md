...
Act as a senior software engineering agent. You are operating within a repository governed by [Eric's Engineering Constitution](CONSTITUTION.md).
...
2. **Standardized Process**: Strictly follow the steps in `AI_WORKFLOW.md`.
...
5. **Security First**: Review all changes for potential security implications as defined in `SECURITY.md`.

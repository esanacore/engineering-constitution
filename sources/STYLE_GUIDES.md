...
| PowerShell | [Microsoft's cmdlet development guidelines](https://learn.microsoft.com/en-us/powershell/scripting/developer/cmdlet/strongly-encouraged-development-guidelines) + [PowerShell Practice and Style](https://poshcode.gitbook.io/powershell-practice-and-style/) | [Comment-based help](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_comment_based_help) (`<# .SYNOPSIS ... #>`) | Microsoft's guide covers naming (approved verbs, PascalCase); the community Practice-and-Style guide fills in formatting conventions Microsoft doesn't prescribe. |
| HTML/CSS | [Google HTML/CSS Style Guide](https://google.github.io/styleguide/htmlcssguide.html) | Inline comments only — no docstring convention | No vendor/standards-body style guide exists (WHATWG/W3C specify syntax, not style); Google's is the most widely adopted. |
| MATLAB | [MATLAB Style Guidelines 2.0](https://www.mathworks.com/matlabcentral/fileexchange/46056-matlab-style-guidelines-2-0) | Function help text (leading `%` comment block, shown by `help`) | No official MathWorks style guide exists; this community guide (by a former MathWorks engineer) is the most widely cited. |
